#!/usr/bin/env python3
"""
Local MCP Server for file system operations
Provides read, write, edit, list, and search capabilities for files and directories
"""
...
@mcp.tool()
def search_files(pattern: str, directory: str = ".", file_pattern: str = "*", max_results: int = 100) -> str:
    """
    ...
    try:
        ...
        result_str = f"Found {len(results)} matches for '{pattern}' in {file_count} files:\n"
        result_str += "\n".join(results)
